<script lang="ts">
	...
	const eventName = "karachi"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Karachi";
	const eventAddress = "15/D & 15/E, Al-Riaz Society, Shaheed Milat Service Road, Karachi Memon Society P.E.C.H.S., Karachi"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recKJktnNAVYv2o7X"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = "https://share.google/bycXotJOl1r96KO7K"
