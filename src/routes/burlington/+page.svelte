<script lang="ts">
	...
	const eventName = "Burlington"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Burlington, VT";
	...
	const directionsURL = "https://maps.app.goo.gl/uVv2EesRHgr3cAuo7"
	const contactLink = ""
	
	// Sponsors Configuration - disable this if you don't have any sponsors to display!
	const sponsorsEnabled = true; // Set to false to hide the entire sponsors section
	const sponsors = [
		{ image: "/example/logo1.png", name: "Google", url: "https://google.com" },
	];
