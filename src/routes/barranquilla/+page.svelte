...
<script lang="ts">
	...
	$: pageDescription = `¡Únete a Daydream ${eventName} en ${eventLocation}! Un game jam liderado por adolescentes donde crearás juegos increíbles con otros estudiantes de secundaria. ¡Comida, talleres y premios incluidos!`;
	$: pageKeywords = `game jam, hackatón, programación para adolescentes, Hack Club, desarrollo de videojuegos, ${eventLocation}, ${eventName}`;
			...
			try {
				...
				if (!response.ok) {
					if (response.status === 500) {
						...
						return "¿Qué tal un juego donde recolectas cristales mágicos para salvar un mundo flotante misterioso?";
					}
				}
...
<div class="flex flex-col items-center justify-center h-screen text-center bg-gradient-to-b from-[#CCF4FD] to-[#B8D9F8] bg-blend-overlay relative">
	...
	<div class="hero-ui-parallax flex flex-col items-center justify-center text-center relative z-5 -translate-y-2">
		...
		<div class="relative inline-block px-4">
			...
			>
				Game jam para estudiantes de colegio
			</h3>
			<img
				src="underline.svg"
				alt=""
			...
			>
				Organizado por adolescentes en {@html eventLocation.replaceAll(" ", "&nbsp;")}
			</h4>
		</div>
	...
	<div class="relative max-w-4xl mx-auto h-full flex items-start pt-24 max-sm:pt-40 px-8 max-sm:px-2">
		<div class="relative z-20 px-20 pt-20 pb-52 rounded-lg mb-0 max-sm:px-18" style="background-image: url('/letter-top.png'), linear-gradient(to bottom, #FCEFC5 100px, transparent 100px), url('/letter-loop.png'); background-size: 100% auto, 100% auto, 100% auto; background-repeat: no-repeat, no-repeat, repeat-y; background-position: top, top, top; background-attachment: local, local, local;">
			...
			<h2 class="text-5xl font-serif italic text-[#8B4513] mb-10 relative">
				Querides hackers, músicos y artistas,
			...
			<div class="text-[#8B4513] font-serif text-xl leading-relaxed space-y-8">
				<p>Bienvenides a la nueva aventura de Hack Club. Este otoño te invitamos a unirte a Daydream, el game jam más grande del mundo, ocurriendo simultáneamente en 100 ciudades.</p>

				<p class="font-bold text-2xl">Hack Club quiere que hagas un juego este otoño.</p>

				<p>¿No te consideras desarrollador de juegos? No hay problema: tenemos muchos talleres en línea y presenciales para que hagas tu primer juego. </p>

				<p>Este otoño te invitamos a aprender algo nuevo, crear algo de lo que te sientas orgulloso, hacer nuevas amistades y vivir una aventura increíble juntes.</p>

				<p class="mb-2">Con cariño,</p>

				<p class="italic text-2xl opacity-85">Augie y Renran de Hack Club HQ</p>
			</div>
		</div>
	</div>
			...
			<div class="relative bg-gradient-to-b from-[#CCF4FD] to-[#AECDF6] px-8 pt-8 pb-16">
				...
				<div class="relative z-10 min-h-40">
					...
					<div class="mt-8 text-center">
						<p class="text-lg text-[#335969]">¡Un gran agradecimiento a Jukebox por nuestras <a href="https://jukeboxprint.com/custom-stickers" class="underline hover:text-[#477783] transition-colors" target="_blank" rel="noopener noreferrer">pegatinas personalizadas</a>! <br> ¿Quieres patrocinar Daydream {eventName}? <a href={contactLink} class="underline hover:text-[#477783] transition-colors">Ponte en contacto</a></p>
					</div>
				</div>
			</div>
...
<div class="w-full bg-[#FCEFC5] flex justify-center py-16 relative overflow-hidden max-h-[400px]">
	...
	<div class="relative w-10/12 h-auto object-contain cursor-text flex flex-row max-lg:flex-wrap md:translate-y-0 max-lg:translate-y-1/5 items-center justify-center align-middle max-w-5xl z-50">
		<img src="gamejam-1-alt.png" alt="Así ganas un" class="flex-shrink min-w-0 object-contain">
...
<div class="w-full bg-gradient-to-b from-[#FDC5D1] to-[#FAE3C9] items-center justify-center px-0 md:px-8 relative pt-36">
	<div class="w-full max-w-5xl lg:max-w-6xl mx-auto px-2 md:px-8">
		<div class="relative w-full min-w-72">
			<img src="banner-city.png" alt="Encuentra un Daydream cerca de ti" class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/3 md:-translate-y-[40%] h-48 w-auto z-100 scale-[1.15] md:scale-[1.65] saturate-70 brightness-110 object-contain px-4 pointer-events-none">
			...
			{#if eventAddress}
				<p class="text-center font-sans text-2xl pt-12 max-sm:text-xl text-[#60574b] z-10000">
					{#if directionsURL}
						Daydream {eventName} se llevará a cabo en <a class="underline text-pink" href={directionsURL}>{eventAddress}</a>.
					{:else}
		...
		">
			...
			<!-- Rounded container -->
				...
				<div class="space-y-8 max-sm:space-y-4 relative z-10">
					...
					Puedes crear cualquier juego que quieras, siempre que se pueda publicar en itch.io. Todos los juegos deben estar en línea para que otres participantes puedan jugarlos. Solo aceptaremos enlaces de envío de itch.io.
						<br>
						<br>
					Aquí hay algunos proyectos geniales de hackatones pasados para inspirarte:
					</p>
					...
					<a href="https://nanomars.itch.io/not-an-idle" target="_blank" class="underline mr-2">Not an Idle</a> por Armand
						...
						<li class="flex items-start">
							<span class="mr-4">•</span>
					<a href="https://juanes10201.itch.io/speedtickers" target="_blank" class="underline mr-2">SPEEDTICKERS</a> por Agustín
						</li>
					</ul>
					
					<p class="text-xl md:text-2xl opacity-90 font-pixel leading-relaxed">
					Tendremos talleres y actividades antes de Daydream para ayudarte a aprender desarrollo de videojuegos usando Godot. 
					</p>
					
					<!-- Bottom section with input -->
					<div class="flex flex-col md:flex-row md:items-end gap-10 pt-8">
						<div>
					<h3 class="text-3xl md:text-4xl font-pixel mb-4">¿Atascado?</h3>
							<button 
...
<div class="w-full pb-24 max-md:pt-16 bg-gradient-to-b from-[#FAE3C9] to-[#e99cce] relative flex flex-col items-center justify-center">
	...
	<img src="faq.png" alt="Preguntas frecuentes" class="mb-12 h-24 scale-175 max-md:scale-120">
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform -rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">¡Todes les estudiantes de secundaria y últimos años de colegio son bienvenides!</p>
		</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">¿Puedo organizar un Daydream en mi ciudad?</h3>
				<p class="text-sm">¡Definitivamente! Escríbenos a daydream@hackclub.com o únete al canal #daydream en Slack.</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">¡Sí! Comida, regalitos y buena vibra están incluidos. Además, si vienes de lejos, cubrimos gasolina o un tiquete de bus/tren.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">¿Qué necesito?</h3>
				<p class="text-sm">Tu laptop, cargadores, artículos de aseo, saco de dormir y una mente abierta.</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">Hack Club ha organizado un hackatón en la sede de GitHub, un game jam en 50 ciudades, un hackatón en un tren de Vermont a Los Ángeles y mucho más.</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			<img src="window-3.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">No soy bueno programando. ¿Igual puedo participar?</h3>
				<p class="text-sm">¡Este game jam es para todos los niveles! Habrá talleres y actividades, así que únete y aprendamos juntes.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			<img src="window-2.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">¿Y si a mis padres les preocupa?</h3>
				<p class="text-sm">¡Estamos para ayudar! Pueden ver nuestra guía para padres o escribirnos a daydream@hackclub.com si tienen preguntas.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			<img src="window-1.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">¿Qué puedo hacer en Daydream?</h3>
				<p class="text-sm">¡CUALQUIER tipo de juego según el tema! Plataformas, novela visual, clicker, etc. ¡Sé lo más creativx posible!</p>
			</div>
		</div>
	</div>
...
<script lang="ts">
	...
	const eventName = 'Barranquilla';
	const eventLocation = 'Barranquilla';
	const eventAddress = 'Corporación Universitaria Reformada'; // Leave this empty if you don't want an address
	// These two are optional
	const directionsURL = 'https://maps.app.goo.gl/A1Tqo1gZV3bHbiFx7';
	const contactLink = 'mailto:barranquilla@daydream.hackclub.com';

	// Sponsors Configuration
	const signupLink =
		'https://forms.hackclub.com/daydream-sign-up?event=recA7vMEOH9sYv9Y3&r=199&lang=es'; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	const sponsorsEnabled = true; // Set to false to hide the entire sponsors section
	const sponsors = [
		{
		...
		},
		{
			...
			image: 'https://barranquilla.gov.co/wp-content/themes/barranquilla/assets/img/logo.svg',
			url: 'https://barranquilla.gov.co/'
		},
		{
			name: 'Corporación Universitaria Reformada',
			image: 'https://www.unireformada.edu.co/wp-content/themes/ureformada/img/logo-ur-azul17.png',
			url: 'https://www.unireformada.edu.co/'
		},
		{
			name: 'JLCPCB',
			image: '/barranquilla/jlcpcb.png',
			url: 'https://jlcpcb.com/'
		},
		{
			name: 'EasyADA',
			image: '/barranquilla/easyada.png',
			url: 'https://easyeda.com/'
		},
		{
			name: 'OSHWLab',
			image: '/barranquilla/oshwlab.png',
			url: 'https://oshwlab.com/'
		},
		{
			name: 'Hack Club',
	...
	const scheduleData: { title: string; items: { event: string; time: string }[] }[] = [
		{
			title: 'Sabado del 27 de Septiembre',
			items: [
				{ event: 'Inicio del evento', time: '10:00 AM' },
				{ event: 'Ceremonia de Apertura', time: '10:30 AM' },
				{ event: 'Charla ponentes centrales', time: '11:00 AM' },
				{ event: 'Empezamos a trabajar en los juegos', time: '12:00 PM' },
				{ event: 'Almuerzo', time: '1:00 PM' },
				{ event: 'Seguimos trabajando en los juegos', time: '2:00 PM' },
				{ event: 'Actividades fisicas de integracion', time: '4:30 PM' },
				{ event: 'Cena', time: '5:00 PM' },
				{ event: 'Agregando y terminando cosas en los juegos', time: '5:30 PM' },
				{ event: 'Fin de los eventos del día', time: '6:00 PM' }
			]
		},
		{
			title: 'Domingo del 28 de Septiembre',
			items: [
				{ event: 'Desayuno y llegada de las personas que no se quedaron', time: '8:30 AM' },
				{ event: 'Puliendo nuestros juegos y terminando cosas', time: '9:30 AM' },
				{ event: 'Almuerzo', time: '12:30 PM' },
				{ event: 'Entregando los juegos para votación', time: '1:30 PM' },
				{ event: 'Votaciónes de juegos', time: '2:00 PM' },
				{ event: 'Ceremonia de premiación', time: '4:00 PM' },
				{ event: 'Cierre del evento', time: '4:30 PM' }
			]
		}
	];
...
>
	...
	>
		...
		<ParticipantSignUp
			{eventName}
			eventLink={signupLink}
			customText="Ingresa tu correo para inscribirte"
		/>
	</div>
...
<div class="w-full relative flex items-start justify-center">
	...
	>
		...
		>
			...
			<div class="text-[#8B4513] font-serif text-xl leading-relaxed space-y-8">
				<p>
					Bienvenides a la nueva aventura de Hack Club. Este otoño te invitamos a unirte a Daydream,
					el game jam más grande del mundo, ocurriendo simultáneamente en 100 ciudades.
				</p>

				<p class="font-bold text-2xl">Hack Club quiere que hagas un juego este otoño.</p>

				<p>
					¿No te consideras desarrollador de juegos? No hay problema: tenemos muchos talleres en
					línea y presenciales para que hagas tu primer juego.
				</p>

				<p>
					Este otoño te invitamos a aprender algo nuevo, crear algo de lo que te sientas orgulloso,
					hacer nuevas amistades y vivir una aventura increíble juntes.
				</p>
...
<div class="w-full bg-[#FCEFC5] py-16 px-8 flex justify-center">
	<div class="relative max-w-4xl w-full">
		...
		>
			...
			>
				<h2 class="text-4xl font-serif text-[#F0F0FF] text-center">Programa</h2>
				<!-- Brush texture overlay for header -->
				<div
					class="absolute top-0 left-0 w-full h-full bg-[url('brushstroking.png')] bg-size-[100vw_100vh] bg-repeat mix-blend-overlay opacity-60 pointer-events-none"
				></div>
					...
					<div class="relative z-10 min-h-40">
						...
						<div class="mt-8 text-center">
							<p class="text-lg text-[#335969]">
								¿Quieres patrocinar Daydream {eventName}?
...
<div
	class="flex flex-row flex-wrap w-full h-auto bg-gradient-to-b from-[#FCEFC5] to-[#FEC1CF] px-36 max-md:px-8 pb-50 max-sm:pb-24 relative"
	id="islands-container"
>
	<img src="/clouds-left-2.png" alt="" class="absolute left-0 w-3/12 top-12 pointer-events-none" />
	<img
		src="/clouds-left-3.png"
		alt=""
		class="absolute left-0 w-2/12 bottom-32 pointer-events-none"
	/>
	<img
		src="/clouds-right-2.png"
		alt=""
		class="absolute right-0 w-3/12 bottom-0 pointer-events-none"
	/>
		...
		<div class="relative translate-y-8 max-md:translate-y-4 z-30">
			...
			>
				...
				>
					...
					<a href={signupLink} class="underline">Regístrate</a>
					en Daydream {eventName}
				</div>
			</div>
		</div>
		<img
		...
		<div class="relative translate-y-24 max-md:translate-y-4 z-30">
			...
			>
				...
				<div
					class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center"
				>
					<span class="font-sans text-[#639DEB] font-bold text-[1.3rem] mr-1">#2:</span> Asiste al evento
					en la Universidad Reformada
				</div>
			</div>
		</div>
		<img
		...
		<div class="relative translate-y-8 max-md:translate-y-4 z-30">
			...
			>
				...
				<div
					class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center"
				>
					<span class="font-sans text-[#AB68E2] font-bold text-[1.3rem] mr-1">#3:</span> Encuentra un
					equipo con otros bachilleres del evento
				</div>
			</div>
		</div>
		<img
		...
		<div class="relative translate-y-24 max-md:translate-y-4 z-30">
			...
			>
				...
				<div
					class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center"
				>
					<span class="font-sans text-[#F2993E] font-bold text-[1.3rem] mr-1">#4:</span> Comienza a crear
					tu juego con ayuda de nuestros talleres!
				</div>
			</div>
		</div>
		<img
	...
	>
		<div class="relative">
			<div
				...
				data-point="5"
			>
				<span class="font-sans text-[#F2CC32] font-bold text-[1.5rem] mr-1">#5:</span> ¡Comparte lo que
				hiciste con el mundo!
			</div>
		</div>
	</div>
...
>
	<div class="w-full max-w-5xl lg:max-w-6xl mx-auto px-2 md:px-8">
		<div class="relative w-full min-w-72">
			<img
				src="banner-city.png"
				alt="Encuentra un Daydream cerca de ti"
			...
			{#if eventAddress}
				<p class="text-center font-sans text-2xl pt-12 max-sm:text-xl text-[#60574b] z-10000">
					{#if directionsURL}
						Daydream {eventName} se llevará a cabo en la
						<a class="underline text-pink" href={directionsURL}>{eventAddress}</a>.
					{:else}
						Daydream {eventName} se llevará a cabo en la
						<span class="underline">{eventAddress}</span>.
					{/if}
				</p>
			{/if}
		</div>
		...
		"
			>
				...
				<div class="space-y-8 max-sm:space-y-4 relative z-10">
					...
					<p class="text-xl md:text-2xl opacity-90 font-pixel">
						Puedes crear cualquier juego que quieras, siempre que se pueda publicar en itch.io.
						Todos los juegos deben estar en línea para que otres participantes puedan jugarlos. Solo
						aceptaremos enlaces de envío de itch.io.
						<br />
						<br />
						Aquí hay algunos proyectos geniales de hackatones pasados para inspirarte:
					</p>
					...
					<ul class="space-y-2 font-pixel text-xl md:text-2xl">
						<li class="flex items-start">
							<span class="mr-4">•</span>
							<a
								href="https://bucketfish.itch.io/remedy-renemy"
								target="_blank"
								class="underline mr-2">Remedy Renemy</a
							> por Tongyu y Kai Ling
						</li>
						<li class="flex items-start">
							<span class="mr-4">•</span>
							<a href="https://nanomars.itch.io/not-an-idle" target="_blank" class="underline mr-2"
								>Not an Idle</a
							> por Armand
						</li>
						<li class="flex items-start">
					...
					<p class="text-xl md:text-2xl opacity-90 font-pixel leading-relaxed">
						Tendremos talleres y actividades antes de Daydream para ayudarte a aprender desarrollo
						de videojuegos usando Godot.
					</p>
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform -rotate-2">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					¿Quién puede participar en Daydream?
				</h3>
				<p class="text-sm">
					Cualquier bachiller puede participar en Daydream! Necesitas tener entre 13-18 años para
					poder participar. Además, debes estar inscrito en un colegio.
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			>
				...
				<p class="text-sm">
					El horario va ser de 24h! Es decir, van a participar desde el sabado hasta el domingo.
					Pueden quedarse en la universidad por la noche para seguir trabajando en sus juegos!
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-2">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					¿Todo esto, es gratis o hay un cobro en el evento?
				</h3>
				<p class="text-sm">
					¡Sí! Comida, regalitos y cualquier cosita que necesites para que te sientas cómodo/a en el
					evento.
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			>
				...
				<p class="text-sm">
					Traer un portatil, un termo de agua, cargadores y la disposición para aprender y disfrutar
					del evento! ✨
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-1 max-md:text-base">
					¿Qué ha hecho Hack Club antes?
				</h3>
				<p class="text-sm">
					Hack Club ha organizado un game jam en 50 ciudades del mundo, un hackatón en un tren a Los
					Ángeles y mucho más. Tambien organizo Scrapyard en Barranquilla en la Universidad del
					Norte
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					No soy bueno en la tecnologia..
				</h3>
				<p class="text-sm">
					No importa si no conoces nada de tecnologia, solo necesitas una idea y un equipo para
					participar. Estaremos dando talleres en como hacer tu propio juego!
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					¿Y si a mis padres les preocupa?
				</h3>
				<p class="text-sm">
					Pueden ver nuestra <a
						class="underline text-[#E472AB]"
						href="https://docs.google.com/document/d/1nXOvEOhzhCVcleEkAGu-_2Rw__LAHGkLuE2bj_OJe-0/edit?usp=sharing"
						>guía para padres</a
					>
					o escribirnos a
					<a class="underline text-[#E472AB]" href="mailto:barranquilla@daydream.hackclub.com"
						>barranquilla@daydream.hackclub.com</a
					> si tienen dudas.
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					¿Qué puedo hacer en Daydream?
				</h3>
				<p class="text-sm">
					CUALQUIER tipo de juego según el tema! Plataformas, novela visual, clicker, etc. Sé lo más
					creativo posible en tu juego.
				</p>
			</div>
		</div>
	</div>
...
<<<<<<< HEAD
>>>>>>> 9af1d6bd72e37c6db940820130040c8a803dec4d
=======
<style>
	:global(body) {
		background-color: #ccf4fd;
...
>>>>>>> 5514158c8765cfecf58960212a1699f2e88abb0d
