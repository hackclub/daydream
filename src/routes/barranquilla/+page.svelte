<script lang="ts">
	...
	const EVENT_LOCATION = 'Barranquilla';
...
>
	...
	>
		...
		<div class="relative inline-block px-4">
			...
			>
				Organizado por adolescentes en {EVENT_LOCATION}
			</h4>
		</div>
		...
		<div class="mt-8 flex flex-col items-center gap-3 z-5 max-md:scale-90">
			...
			>
				<input
					type="email"
					name="email"
					placeholder="Ingresa tu email para registrarte"
	...
	>
		...
		>
			...
			<div class="text-[#8B4513] font-serif text-xl leading-relaxed space-y-8">
				<p>
					Los hackathons son <em class="italic font-bold">mágicos</em>. Probablemente ya lo has
					sentido antes: quedarte despierto toda la noche con tus amigos, construyendo algo que
					realmente funciona, finalmente conociendo a todos cuyo código has admirado. Esa emoción
					cuando tu código compila a las 3:00 am y de repente tu idea loca se vuelve real.
				</p>

				<p class="font-bold text-2xl">Hack Club quiere que organices un hackathon.</p>

				<p>
					Queremos que más hackers que nunca de todo el mundo tengan esta experiencia que cambia la
					vida, y queremos tu ayuda para que eso suceda.
				</p>

				<p>
					¡Regístrate para organizar un evento Daydream en tu ciudad! Todos nuestros hackathons son
					dirigidos por adolescentes. No necesitas tener experiencia previa, y Hack Club te
					proporcionará financiamiento y mentoría.
				</p>

				<p>
					¡Nuestro objetivo es que <span class="font-bold">4,000 Hack Clubbers</span> hagan
					proyectos de los que estén orgullosos a través de Daydream, y estamos dando más de
					<span class="font-bold">$120k en financiamiento</span> a organizadores como tú!
				</p>

				<p class="text-center font-bold text-2xl mt-10 text-[#2C3E50]">
					¡Mira nuestro <a
						class="underline hover:text-pink"
						href="https://www.youtube.com/watch?v=hNYsNSY7Vz0">video!</a
					>
				</p>
			</div>
		</div>
		...
		<div class="relative translate-y-8 max-md:translate-y-4 z-30">
			...
			>
				...
				>
					...
					<a href="https://forms.hackclub.com/daydream" class="underline">Regístrate</a>
					para Daydream {EVENT_NAME}
				</div>
			</div>
		</div>
		<img
		...
		<div class="relative translate-y-24 max-md:translate-y-4 z-30">
			...
			>
				...
				<div
					class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center"
				>
					<span class="font-sans text-[#639DEB] font-bold text-[1.3rem] mr-1">#2:</span> Encuentra un
					equipo de otros adolescentes en el evento
				</div>
			</div>
		</div>
		<img
		...
		<div class="relative translate-y-8 max-md:translate-y-4 z-30">
			...
			>
				...
				<div
					class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center"
				>
					<span class="font-sans text-[#AB68E2] font-bold text-[1.3rem] mr-1">#3:</span> Comienza a
					construir tu juego - <u>no se necesita experiencia</u>
				</div>
			</div>
		</div>
		<img
		...
		<div class="relative translate-y-24 max-md:translate-y-4 z-30">
			...
			>
				...
				<div
					class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center"
				>
					<span class="font-sans text-[#F2993E] font-bold text-[1.3rem] mr-1">#4:</span> Asiste a talleres
					o habla con uno de nuestros mentores para obtener ayuda
				</div>
			</div>
		</div>
		<img
...
<div
	class="w-full bg-gradient-to-b from-[#FDC5D1] to-[#FAE3C9] items-center justify-center px-32 relative pt-36"
>
	<div class="max-md:absolute max-md:left-1/2 max-md:-translate-x-1/2 max-md:z-100 max-sm:pt-16">
		<div class="relative w-full max-w-3xl mx-auto min-w-72 max-md:mx-0">
			<div
				class="absolute top-0 left-1/2 -translate-x-1/2 max-md:-translate-y-1/2 max-sm:translate-y-[calc(-50%-4rem)] h-48 w-auto z-100 flex items-center justify-center px-4 pointer-events-none"
			>
				<h2
					class="text-4xl font-serif italic text-[#60574b] bg-white px-6 py-3 rounded-lg shadow-lg max-md:text-3xl max-sm:text-2xl text-center"
				>
					{EVENT_LOCATION}
				</h2>
			</div>
			<img
				src="hole.png"
				alt=""
				class="w-full h-full max-w-3xl max-sm:scale-200 pointer-events-none"
			/>
			<div
			...
			<p
				class="absolute left-1/2 -translate-x-1/2 font-sans text-center text-2xl pt-12 max-sm:pt-40 max-sm:text-xl w-max max-w-[80vh] max-md:max-w-full md:px-12 text-[#60574b] z-10000"
			>
				¡Todos los eventos daydream son organizados por estudiantes de secundaria como tú! <br />
				<span class="font-bold"
					><a class="underline hover:text-pink" href="https://forms.hackclub.com/daydream"
						>¡Regístrate</a
					> para organizar ahora!</span
				>
			</p>
		</div>
	</div>
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform -rotate-2">
			...
			>
				...
				<p class="text-sm">
					¡Todos los estudiantes de secundaria y últimos años de primaria son bienvenidos!
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					¿Puedo organizar un Daydream en mi ciudad?
				</h3>
				<p class="text-sm">
					¡Definitivamente! Contáctanos en daydream@hackclub.com o únete a #daydream en slack.
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-2">
			...
			>
				...
				<p class="text-sm">
					¡Sí! Comida, regalos y buenas vibras están incluidos. Además, si vienes desde lejos,
					cubriremos el costo de gasolina o un boleto de autobús/tren.
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			>
				...
				<p class="text-sm">
					¡Tu laptop, cargadores, artículos de aseo, sacos de dormir y una mente abierta!
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			>
				...
				<p class="text-sm">
					¡Hack Club ha organizado un hackathon en la sede de GitHub, un Game Jam en 50 ciudades, un
					hackathon en un tren desde Vermont hasta Los Ángeles, y más!
				</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					No soy bueno programando. ¿Puedo participar?
				</h3>
				<p class="text-sm">
					¡Este game jam es para todos los niveles de habilidad! Tendremos talleres y otros eventos,
					así que únete y aprendamos juntos.
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			...
			>
				...
				<p class="text-sm">
					¡Estamos aquí para ayudar! Puedes ver nuestra guía para padres aquí, o pueden contactarnos
					en daydream@hackclub.com para preguntas.
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			>
				...
				<p class="text-sm">
					¡CUALQUIER tipo de juego basado en el tema! Plataformero, novela visual, juego de clics,
					etc. ¡Sé lo más creativo posible!
				</p>
			</div>
		</div>
	</div>
...
<div class="w-full bg-[#FFFFF8] relative min-h-80">
	...
	>
		<p class="text-gray-700 mb-2">Hecho con ♡ por adolescentes, para adolescentes en Hack Club</p>
