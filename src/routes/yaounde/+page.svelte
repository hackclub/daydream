<script lang="ts">
	...
	const eventName = "Yaounde"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Yaounde";
	const eventAddress = "Polytechnic Yaounde"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-rsvp?event=recQwyDQtvkBxi3V8"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = "https://maps.app.goo.gl/Pqx6zE9fXiRuyRrc9"
	const contactLink = "mailto:yaounde@daydream.hackclub.com"
