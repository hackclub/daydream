<<<<<<< HEAD:src/routes/addisababa/+page.svelte
<script lang="ts">
	/**
...
<script lang="ts">
	...
	// These two are optional
	const directionsURL =
		'https://www.google.com/maps/place/Abrehot+Library/@9.0304294,38.7600361,17z/data=!3m1!4b1!4m6!3m5!1s0x164b856cccf9da43:0xcb92a857309700c0!8m2!3d9.0304294!4d38.762611!16s%2Fg%2F11rn0cb9_x?entry=ttu&g_ep=EgoyMDI1MDgxMS4wIKXMDSoASAFQAw%3D%3D';
	const contactLink = 'mailto:addisababa@daydream.hackclub.com';
	...
	const scheduleData: { title: string; items: { event: string; time: string }[] }[] = [
		{
			title: 'Saturday, September 27th',
			items: [
				{ event: 'Doors open', time: '5:30 - 6:00 / 11:00AM - 12:00PM' },
				{ event: 'Opening ceremony', time: '6:00 - 6:30 / 12:00PM - 12:30PM' },
				{ event: 'Workshop', time: '6:30 - 8:00 / 12:30PM - 2:00PM' },
				{ event: 'Start working on your project!', time: '8:00 - 12:30 / 2:00PM - 6:30PM' },
				{ event: 'Dinner', time: '12:30 - 1:30 / 6:30PM - 7:30PM' },
				{ event: 'Continue to work!', time: '1:30 - 4:30 / 7:30PM - 10:30PM' },
				{ event: 'Check in while working!', time: '4:30 - 5:00 / 10:30PM - 11:00PM' },
				{ event: 'Midnight Snack/Nap!', time: '5:00 - 6:00 / 11:00PM - 12:00AM' },
				{ event: 'Continue to work!', time: '6:00 - 1:30 / 12:00AM - 7:30AM' }
			]
		},
		{
			title: 'Sunday, September 28th',
			items: [
				{ event: 'Breakfast', time: '1:30 - 2:15 / 7:30AM - 8:15AM' },
				{ event: 'Lock in! Last ~5 hours!', time: '2:15 - 6:00 / 8:15AM - 12:00PM' },
				{ event: 'End of event!', time: '6:00 / 12:00PM' },
				{ event: 'Closing ceremony', time: '6:00 - 6:30 / 12:00PM - 12:30PM' }
			]
		}
	];
...
>
	...
	<section class="jukebox-highlight">
		<div class="jukebox-content">
			<img
				src="https://raw.githubusercontent.com/SamuelGirmaMeta/COC/refs/heads/main/jukebox-logo.svg"
				alt="Jukebox Logo"
				class="jukebox-logo"
			/>
			<p>
				Big shoutout to Jukebox for our <a
					...
					target="_blank">custom stickers</a
				>! Thank you for making our event even more special with your amazing designs.
			</p>
		</div>
	</section>
	<style>
		.jukebox-highlight {
			...
			text-align: center;
			margin: 3rem auto 2rem auto; /* center and move it slightly lower */
		}

		.jukebox-highlight .jukebox-logo {
		...
		"
			>
				...
				<div class="space-y-8 max-sm:space-y-4 relative z-10">
					...
					<p class="text-xl md:text-2xl opacity-90 font-pixel">
						You can make any game you want as long as it can be deployed on itch.io! All games made
						must be deployed and available online for other participants to play and experience. We
						will only accept itch.io submission links.
						<br />
						<br />
						Here are some cool projects from past hackathons to get you inspired:
					</p>
					...
					<p class="text-xl md:text-2xl opacity-90 font-pixel leading-relaxed">
						We'll have workshops and activities before Daydream to help you learn game development
						using Godot!
					</p>
...
<<<<<<< HEAD
>>>>>>> 9af1d6bd72e37c6db940820130040c8a803dec4d:src/routes/addis-ababa/+page.svelte
=======
<style>
	:global(body) {
		background-color: #ccf4fd;
