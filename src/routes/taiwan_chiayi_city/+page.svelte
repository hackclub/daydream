<script lang="ts">
	...
	const eventName = "Daydream Chiayi City";
	const eventLocation = "Chiayi City";
	const eventAddress = "600 嘉義市東區大雅路二段738號"; // Leave this empty if you don't want an address
	// These two are optional
	const directionsURL = "https://maps.app.goo.gl/eRMR2a4V6hLfXBDy8"
