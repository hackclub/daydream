...
<script lang="ts">
	...
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recvUAUk1y7P7RQb7"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
