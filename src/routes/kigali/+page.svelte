<script lang="ts">
	...
	const directionsURL = 'https://maps.app.goo.gl/vjEnnxe6pM8gKNvL7';
	const contactLink = 'mailto:muganwarogers@gmail.com';

	const signupLink = 'https://forms.hackclub.com/daydream-sign-up';
	const sponsorsEnabled = true;
	const sponsors = [
		{
			image: 'https://storage.jukeboxprint.com/s/images/jukebox-logo.svg',
			name: 'Jukebox',
			url: 'https://www.jukeboxprint.com/custom-stickers'
		},
		{
			image: 'https://fablab-leuven.be/wp-content/uploads/2019/04/Fab_Lab_logo.svg_.png',
			name: 'Fablab Rwanda',
			url: 'https://fablab.rw/'
		}
	];
	...
	const scheduleData: { title: string; items: { event: string; time: string }[] }[] = [
		{
			...
			items: [
				{ event: 'Doors open', time: '6:00 AM' },
				{ event: 'Opening ceremony', time: '7:00 AM' },
				{ event: 'Hacking Begins!', time: '8:00 AM' },
				{ event: 'Breakfast & Workshops', time: '9:00 AM' },
				{ event: 'Hacking continues', time: '10:00 AM' },
				{ event: 'Lunch & Mentorship', time: '12:00 PM' },
				{ event: 'Evening hacking', time: '6:00 PM' }
			]
		},
		{
			title: 'Sunday, September 28th',
			items: [
				{ event: 'Final Sprint', time: '7:30 AM' },
				{ event: 'Submissions Due', time: '8:00 AM' },
				{ event: 'Demo Presentations', time: '8:30 AM' },
				{ event: 'Awards Ceremony', time: '11:00 AM' },
				{ event: 'Closing Celebration', time: '12:30 PM' }
			]
		}
	];
...
>
	...
	>
		...
		<ParticipantSignUp {eventName} eventLink={"https://forms.hackclub.com/daydream-sign-up?event=recJjp9gpq0GI35Nc"} />
	</div>
					...
					<div class="relative z-10 min-h-40">
						{#if sponsors.length > 0}
							...
							{:else}
								...
								<div class="flex justify-center">
									<div
										class="grid gap-8 w-full items-center justify-items-center max-w-4xl {sponsors.length ===
										1
											? 'grid-cols-1'
											: sponsors.length === 2
						...
						{#if contactLink}
							...
							<div class="mt-8 text-center">
								<p class="text-lg text-[#335969]">
									...
									provided by Jukebox <br /> Want to sponsor Daydream {eventName}?
									<a
										href="https://hcb.hackclub.com/donations/start/daydream-matimba"
										class="underline hover:text-[#477783] transition-colors">Get in touch</a
									>
								</p>
							</div>
						{/if}
