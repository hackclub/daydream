<script lang="ts">
	...
	const eventName = "Tanta";
	const eventLocation = "";
	const eventAddress = "Tanta Club Street – in front of the Security Directorate, Tanta, Egypt";
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recnXfVjgFrkNZ2TB"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = "https://maps.app.goo.gl/VRkCauSq3q3xrLgj8"
	const contactLink = "mailto:tanta@daydream.hackclub.com"
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
				...
				{ event: "Gathering and Opening ceremony", time: "9:30 AM" },
