	...
	const scheduleData: { title: string; items: { event: string; time: string }[] }[] = [
		{
			...
			items: [
				{ event: 'Doors open', time: '7:30 AM' },
				{ event: 'Opening ceremony', time: '8:00 AM' },
				{ event: 'Start working on your project!', time: '8:30 AM' },
				{ event: 'Jumpstart Workshop', time: '9:00 AM' },
				{ event: 'Libby Activity', time: '11:00 AM' },
				{ event: 'Lunch', time: '12:30 PM' },
				{ event: 'Storyboard Workshop', time: '2:00 PM' },
				{ event: 'Jackbox', time: '4:00 PM' },
				{ event: 'Dinner', time: '6:00 PM' },
				{ event: 'Closing Ceremony', time: '8:00 PM' },
				{ event: 'Doors closing', time: '8:30 PM' }
			]
		}
	];
...
>
	...
	<img
		src="nyc/logo.png"
		id="nycLogo"
		style="position: absolute; height: 20%; width: auto; bottom: 0; z-index: 100; margin-bottom: 0;"
		alt="Daydream NYC Logo"
	/>
	...
	<div class="relative max-w-4xl w-full">
		...
		>
			...
			<div
				...
				style="border-bottom: 8px solid #B4B4C5;"
			>
				<h2 class="text-4xl font-serif text-[#F0F0FF] text-center">Special Thanks</h2>
				<!-- Brush texture overlay for header -->
				<div
					class="absolute top-0 left-0 w-full h-full bg-[url('brushstroking.png')] bg-size-[100vw_100vh] bg-repeat mix-blend-overlay opacity-60 pointer-events-none"
				></div>
...
>
	...
	>
		<div class="relative">
			<div
				class="bg-[url('/nyc/card-final.png')] bg-contain bg-no-repeat bg-center text-2xl font-serif pt-24 px-8 w-128 h-96 text-center max-md:w-80 max-md:h-80 max-md:text-xl max-md:pt-16 animate-hover ![--hover:-0.15rem] ![animation-delay:1.9s]"
				data-point="5"
			>
