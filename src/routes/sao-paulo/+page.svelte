<script lang="ts">
	...
	$: pageDescription = `Registre-se para Daydream ${eventName}! Um hackathon-game jam liderado por adolescentes onde você vai construir jogos incríveis com outros estudantes de Ensino Médio. Tudo gratuito!`;
	...
	<div class="relative max-w-4xl mx-auto h-full flex items-start pt-24 max-sm:pt-40 px-8 max-sm:px-2">
		<div class="relative z-20 px-20 pt-20 pb-52 rounded-lg mb-0 max-sm:px-18" style="background-image: url('/letter-top.png'), linear-gradient(to bottom, #FCEFC5 100px, transparent 100px), url('/letter-loop.png'); background-size: 100% auto, 100% auto, 100% auto; background-repeat: no-repeat, no-repeat, repeat-y; background-position: top, top, top; background-attachment: local, local, local;">
			...
			<h2 class="text-5xl font-serif italic text-[#8B4513] mb-10 relative">
				Caros Hackers, Músicos e Artistas,
			...
			<div class="text-[#8B4513] font-serif text-xl leading-relaxed space-y-8">
				<p>Bem-vindo à aventura mais nova do Hack Club. Nessa primavera, ou Outono no Hemisfério Norte, te convidamos para Daydream, a maior Game Jam acontecendo simultaneamente em 100 cidades.</p>

				<p class="font-bold text-2xl">Hack Club quer que você faça um jogo nessa primavera.</p>

				<p>Não se considera um game dev? Sem problemas - temos todo suporte para você fazer seu primeiro jogo! </p>
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform -rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Quem pode participar no Daydream? É de graça?</h3>
				<p class="text-sm">Todos estudantes de Ensino Médio e Ensino Fundamental 2 são bem-vindos!</p>
		</div>
		</div>
		...
		<div class="relative transform rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Tudo isso de graça?</h3>
				<p class="text-sm">Sim! Comida, brinde e boa energia incluso. Se você está vindo de longe, podemos conversar para cobrir valor de passagem de ônibus ou trem.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">O que eu preciso?</h3>
				<p class="text-sm">Seu laptop, carregador e uma mente aberta!</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-1 max-md:text-base">O que Hack Club já fez?</h3>
				<p class="text-sm">Hack Club já fez um hackathon na sede do GitHub, uma Game Jam em 50 cidades, um hackathon em um trem de Vermont para Los Angeles, e muito mais!</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			<img src="window-3.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Não sou bom com código. Posso participar?</h3>
				<p class="text-sm">Essa game jam é para todos os níveis! Junte-se a nós e bora aprender junto.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			<img src="window-2.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Meus pais estão preocupados, o que eu faço?</h3>
				<p class="text-sm">Estamos aqui para ajudar! Contacte-nos em sao-paulo@daydream.hackclub.com.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			<img src="window-1.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">O que posso fazer no Daydream?</h3>
				<p class="text-sm">QUALQUER jogo baseado no tema! Platformer, visual novel, clicker game, etc. Seja criativo!</p>
			</div>
		</div>
	</div>
