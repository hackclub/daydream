<script lang="ts">
	...
	const eventName = 'Silicon Valley'; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = 'San Jose';
	const eventAddress = '3090 Alum Rock Ave, San Jose, CA 95127'; // Leave this empty if you don't want an address
	const signupLink = 'https://forms.hackclub.com/daydream-sign-up?event=recro0X4uHS1vxztZ'; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = 'https://maps.app.goo.gl/jVrVyvKDtFFzatN36';
	...
	const sponsors = [
		...
		{
			image: '/sv/Minifantasy.png',
			name: 'Minifantasy',
			url: 'https://www.minifantasy.net/'
		},
		{
									...
									{#each sponsors.slice(0, 4) as sponsor}
										<a
											...
											class={'bg-white/20 rounded-lg p-4 w-full h-20 flex items-center justify-center hover:bg-white/40 transition-colors ' +
												(sponsor.name === 'YRI Fellowship'
													? 'shadow-[0_0_15px_5px_rgba(255,215,100,0.65)]'
													: '')}
											target="_blank"
