<script lang="ts">
	...
	const eventName = "Cairo"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Cairo";
	const eventAddress = ""; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recYurNMCH7FnmYN2"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = ""
	const contactLink = "mailto:cairo@daydream.hackclub.com"
	
	// Sponsors Configuration - disable this if you don't have any sponsors to display!
	const sponsorsEnabled = true; // Set to false to hide the entire sponsors section
	const sponsors = [
		{ image: "/example/logo1.png", name: "Skills Area", url: "#" }
	];
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
            	...
            	{ event: "Start working on your project!", time: "11:00 PM" },
            	{ event: "Lunch", time: "12:30 PM" },
            	{ event: "Workshop 1", time: "2:00 PM" },
            	{ event: "Activity 1", time: "4:00 PM" },
            	{ event: "Workshop 2", time: "4:00 PM" },
            	{ event: "Dinner", time: "6:00 PM" },
            	{ event: "uhhh", time: "8:00 PM" },
