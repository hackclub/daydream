<script lang="ts">
	...
	const eventName = "Vermont"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Burlington, Vermont";
	const eventAddress = "15 Falls Road, Burlington, Vermont"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recCHrScTK2fNFA9R"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = ""
	const contactLink = "mailto:vermont@daydream.hackclub.com"
	
	// Sponsors Configuration - disable this if you don't have any sponsors to display!
	const sponsorsEnabled = true; // Set to false to hide the entire sponsors section
	const sponsors = [
		{ image: "https://assets.hackclub.com/flag-standalone.svg", name: "Hack Club", url: "https://hackclub.com" },
	];
