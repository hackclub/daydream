	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		...
		},
		{
			...
			items: [
				...
				{ event: "Ceremonia de clausura y premios", time: "6:00 PM" },
				{ event: "Fin del evento", time: "6:30 PM" }
			]
		}
	];
			...
			<!-- Rounded container -->
				...
				<div class="space-y-8 max-sm:space-y-4 relative z-10">
					...
					<p class="text-xl md:text-2xl opacity-90 font-pixel leading-relaxed">
						¡Tendremos talleres y actividades durante Daydream para ayudarte con tu proyecto!
					</p>
					
					<!-- Bottom section with input -->
					<div class="flex flex-col md:flex-row md:items-end gap-10 pt-8">
						<div>
							<h3 class="text-3xl md:text-4xl font-pixel mb-4">¿Sin ideas?</h3>
							<button 
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform -rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">¡Cualquier estudiante con menos de 18 años es bienvenido!</p>
		</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">¡Contáctanos a través de valencia@daydream.hackclub.com y tal vez podamos trabajar juntos!</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">Tu ordenador/portátil, cargadores, una mente abierta y todo lo que creas necesario para desarrollar tu creatividad! Hasta un Blåhaj si lo crees necesario.</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			<img src="window-3.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">No soy bueno en programación. ¿Puedo participar?</h3>
				<p class="text-sm">¡Este game jam es para todos los niveles de habilidad! Es un buen evento para aprender y mejorar tus habilidades.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">¡Estamos aquí para ayudar! Puedes ver nuestra guía para padres, o pueden escribir a valencia@daydream.hackclub.com con sus preguntas.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">¡Cualquier tipo de juego! Plataformas, novela visual, juego de clics, etc. ¡Sé lo más creativ@ posible!</p>
			</div>
		</div>
	</div>
